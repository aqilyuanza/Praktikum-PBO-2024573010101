...
public class AbstractionTest {
    public static void main(String[] args) {
        ...
        // Create accounts
        BankAccount account1 = new BankAccount("ACC001", "Aqil Yuanza", 1000.0, "Aqil123");
        SavingsAccount account2 = new SavingsAccount("SAV001", "Teuku Fazi", 5000.0, "Fazi123", 3.5);

        // Test public interface
        System.out.println("\n--- Testing Basic Bank Account ---");
        account1.displayAccountInfo();
        account1.deposit(500.0);
        account1.withdraw(200.0, "Aqil123");
        account1.displayAccountInfo();

        System.out.println("\n--- Testing Saving Account ---");
        account2.displayAccountInfo();
        account2.applyMonthInterest();
        account2.displayAccountInfo();

        System.out.println("\n--- Testing Transfer ---");
        account2.transfer(account1, 1000.0, "Fazi123");
        account1.displayAccountInfo();
        account2.displayAccountInfo();
        ...
        // account1.authenticate("Aqil123"); // ERROR - private method
        ...
        System.out.println("Withdrawal succesfull: " + success);
